...
- Statistical procedures, macros, and the `.sas7bdat` format are **out of
  scope** for the current version — please discuss in an issue before working
  on anything in that space.
